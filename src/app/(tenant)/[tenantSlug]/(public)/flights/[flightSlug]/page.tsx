...
import { ArrowLeft, PlaneTakeoff, Clock } from "lucide-react";

import { getCachedTenant } from "@/shared/lib/db";
import { getPublicFlightBySlug } from "@/features/public-site/lib/public-cache";
...
export async function generateMetadata({
  ...
  const [flight, locale] = await Promise.all([
    getPublicFlightBySlug(tenant.id, flightSlug),
    getVisitorLocale(),
  ]);
